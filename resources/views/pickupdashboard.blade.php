...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" data-wf-page="605538017156323a2f5ab124" data-wf-site="604d41d40c813292693d08e7">
    ...
    <body class="antialiased bodyClass">
        ...
        <div class="pickup_orders">
            ...
            <div id="{{$order->id}}" class="pickup_order" {{count($orders) > 0 ? '':'hidden'}}>
                                    ...
                                    <div class="order_detail_line_section_wraper">
                                        <div class="order_detail_line_section order_detail_line_3">
                                            ...
                                            <div class="order_detail_qty">
                                                ...
                                                <select id="available_{{$order->id}}_{{$line->id}}" class="order_detail_line_field order_detail_qty_purchased" qty="{{$line->qty}}" onchange="availableChange(this)">
                                                </select>
                                            </div>
                                        </div>
                                        <div class="order_detail_line_section order_detail_line_4">
