                    ...
                    <div id="supplier_data_edit_frame" class="product_location_data_entry">
                        <div class="product_location_data_edit">
                            ...
                            <div class="product_location_data_entry_buttons buttons_frame_height">
                                <input type="button" class="edit_button w-button box_shadow" value="Edit" onclick="editButtonClick('{{$location->id}}', this)">
                                <input type="button" class="delete_button w-button box_shadow" value="Delete" onclick="deleteButtonClick('{{$location->id}}', this)">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="product_location_section">
                        ...
                        <div class="product_location_data_edit">
                            ...
                            <div class="product_location_data_entry_buttons">
                                <input type="button" class="edit_button box_shadow w-button" value="Edit" onclick="editButtonClick('location-id', this)">
                                <input type="button" class="delete_button box_shadow w-button" value="Delete" onclick="deleteButtonClick('location-id', this)">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="product_location_data_entry">
                        <div class="add_location_form_frame w-form">
                            <form id="add_form" class="add_location">
                                ...
                                <div class="product_location_add_buttons_frame">
                                    <input type="button" value="Accept Changes" data-wait="Please wait..." class="accept_button box_shadow w-button" onclick="acceptLocationChangesClick('location-id', this)">
